...
(_Oct 2 2017_)
* FWIW, appears JAX-RS 2.0 under WebSphere no longer exposes the Jackson classes, so that will necessitate a change to this approach: [https://www.ibm.com/docs/en/was-liberty/base?topic=liberty-jax-rs-20-behavior-changes](https://www.ibm.com/docs/en/was-liberty/base?topic=liberty-jax-rs-20-behavior-changes) (_Feb 15 2017_)
